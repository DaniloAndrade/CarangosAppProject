...
public class EventoPublicacoesRecebidas extends BroadcastReceiver {
    ...
    public static final String PUBLICACOES_RECEBIDAS = "publicacoes recebidas";
    private BuscaMaisPublicacoesDelegate delegate;

    private EventoPublicacoesRecebidas(BuscaMaisPublicacoesDelegate delegate) {
    ...
    public void desregistra(CarangosApplication application) {
        MyLog.i("Receiver Não esta mais ouvindo eventos!!! ");
